...
// Shows all the LUNCH TIME DIVISION-2 PROBLEM 1
router.get("/div2prob1", function(req,res) {
	//console.log("Got it!!");
	ltdiv2prob1.find({},function(err, allProblems){
		if(err) {
			console.log(err);
		} else {
			res.render("problems/lt/div2prob1",{problems: allProblems});
		}
	});
});
...
// Shows all the LUNCH TIME DIVISION-2 PROBLEM 2
router.get("/div2prob2", function(req,res) {
	//console.log("Got it!!");
	ltdiv2prob2.find({},function(err, allProblems){
		if(err) {
			console.log(err);
		} else {
			res.render("problems/lt/div2prob2",{problems: allProblems});
		}
	});
});
...
// Shows all the LUNCH TIME DIVISION-2 PROBLEM 3
router.get("/div2prob3", function(req,res) {
	//console.log("Got it!!");
	ltdiv2prob3.find({},function(err, allProblems){
		if(err) {
			console.log(err);
		} else {
			res.render("problems/lt/div2prob3",{problems: allProblems});
		}
	});
});
...
// Shows all the LUNCH TIME DIVISION-2 PROBLEM 4
router.get("/div2prob4", function(req,res) {
	//console.log("Got it!!");
	ltdiv2prob4.find({},function(err, allProblems){
		if(err) {
			console.log(err);
		} else {
			res.render("problems/lt/div2prob4",{problems: allProblems});
		}
	});
});
...
// Shows all the LUNCH TIME DIVISION-2 PROBLEM 5
router.get("/div2prob5", function(req,res) {
	//console.log("Got it!!");
	ltdiv2prob5.find({},function(err, allProblems){
		if(err) {
			console.log(err);
		} else {
			res.render("problems/lt/div2prob5",{problems: allProblems});
		}
	});
});
